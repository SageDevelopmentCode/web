...
export default function MobileSignupModal({
  isOpen,
  onClose,
  onSignupSuccess,
  ...
  const handleVerificationPaste = (index: number, e: React.ClipboardEvent) => {
    ...
    if (/^\d{6}$/.test(pastedData)) {
      ...
      const lastInput = document.getElementById(`mobile-verification-5`);
      lastInput?.focus();
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative w-full max-h-[90vh] overflow-y-auto rounded-t-3xl transition-all duration-300 transform ${
      ...
      >
        ...
        <div className="px-6 pb-6">
            ...
            <>
              ...
              <div className="mb-4">
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-xl border-2 outline-none placeholder-gray-500 text-base ${
              ...
              {/* Password Input */}
              <div className={isLoginMode ? "mb-6" : "mb-4"}>
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 pr-12 rounded-xl border-2 outline-none placeholder-gray-500 text-base ${
                ...
                <div className="flex justify-center gap-2 mb-6">
                  {verificationCode.map((digit, index) => (
                    <input
                      ...
                      className="w-10 h-10 text-center text-lg font-bold rounded-lg border-none outline-none"
                      style={{
                        backgroundColor: "#D6E5E2",
                        color: "#2F4A5D",
                      }}
          ...
          <button
            ...
            disabled={isLoading}
            className={`w-full py-3 text-white font-bold transition-all hover:opacity-90 cursor-pointer mb-4 ${
        ...
        {/* Background Image - full width for mobile */}

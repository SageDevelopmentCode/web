    ...
    <>
      ...
      {isSignupModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
          ...
          {/* Modal content */}
          <div
            className="relative w-[90vw] max-w-md mx-4 rounded-3xl overflow-hidden"
            ...
            <div className="p-8 pb-0">
              ...
              <div className="mb-4">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg border-none outline-none placeholder-gray-500"
                  style={{
              ...
              {/* Sign Up Button */}
              <button
                className="w-full py-3 text-white font-bold transition-all hover:opacity-90"
                style={{
